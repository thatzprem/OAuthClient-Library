...
#import "NTEighthViewController.h"
#import "GoogleDriveConnector.h"

@interface NTEighthViewController (){
...
@implementation NTEighthViewController
...
- (void)viewDidLoad
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(receiveTestNotification:)
                                                 name:@"googleDriveSuccessNotification"
                                               object:nil];
    
    //    googleDriveConnector = [[FaceBookConnector alloc] initWithAuthorizingWebView:self.webView];
...
-(void)updateText:(id)sender{
    ...
    UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"Google Drive Service"
