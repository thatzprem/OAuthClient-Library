...
#import "NTSeventhViewController.h"
#import "NTView.h"
#import "DropBoxConnector.h"



@interface NTSeventhViewController ()
{
...
@implementation NTSeventhViewController
...
- (void)viewDidLoad
{
    ...
    self.view.navigationBar.title = @"Drop box";
...
-(void) setupViewForAuthentication
{
    ...
    UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"DropBox Service"
