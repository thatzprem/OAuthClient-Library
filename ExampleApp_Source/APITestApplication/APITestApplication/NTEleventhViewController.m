...
#import "NTEleventhViewController.h"
#import "NTView.h"
#import "TumblrConnector.h"

@interface NTEleventhViewController (){
    
    TumblrConnector *tumblrManager;
}
...
@implementation NTEleventhViewController
...
- (void)viewDidLoad
{
    ...
    self.view.navigationBar.title = @"Tumblr";
...
-(void)login
{
    ...
    tumblrManager = [[TumblrConnector alloc]initWithConsumerKey:@"4baea9e751b7bf404e5831525ad36e53" secret:@"478068baf865989f"webViewToAuthorize:self.view.webView confirmation:^(BOOL confirm) {
...
-(void) setupViewForAuthentication
{
    ...
    UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"Tumblr Service"
...
-(void)getUserProfile
{
    ...
    [tumblrManager getUserProfile:^(NSString *details) {
...
{
    self.view.textView.hidden = NO;
    [tumblrManager getUseFriendList:^(NSString *details) {
