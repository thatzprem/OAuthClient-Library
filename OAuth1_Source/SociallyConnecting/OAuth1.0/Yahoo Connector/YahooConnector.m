...
-(void) getOAuthAccessTokenconfirmation:(void (^)(BOOL))handler
{
    ...
    [parameter setRequestTokenURL:@"https://api.login.yahoo.com/oauth/v2/get_request_token"];
    [parameter setAuthorizationURL:@"https://api.login.yahoo.com/oauth/v2/request_auth"];
    [parameter setAccessTokenURL:@"https://api.login.yahoo.com/oauth/v2/get_token"];
    [parameter setCallBackURL:@"http://www.thatzprem.com"];
